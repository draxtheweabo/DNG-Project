...
<head>
<title>Office Specialist Home Page</title>
</head>
...
<form action="Office Specialist Home Page.php" method="post">
...
<div class="sidenav">
  <a class="active" href="OfficeSpecialistHomePage.php" style="font-family: inter; font-size: 16px; font-weight: bold;" ><img src="Assets/navicons/activehome.png" alt="Home Icon"> Home</a>
