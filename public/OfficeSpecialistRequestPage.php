...
.amazing-container input[name^="reject"]:hover td {
    background-color: #FF0000; 
}
...
.amazing-container input[name^="approve"]:hover td{
background-color: #00FF00;
color: #FFFFFF;
}
...
<div class="sidenav">
    ...
    <a class="active" href="OfficeSpecialistRequestPage.php" style="font-family: inter; font-size: 16px; font-weight: bold;" ><img src="Assets/navicons/activerequest.png" alt="Request Icon"> Queue</a>
...
<div class="titleheader">
  ...
  <h1 style="font-family: inter; font-size: 30px; font-weight: bold; color: #4F4F4F">LIST OF REQUESTS</h1>
...
<?php
 ...
 if($department == "")
 {
 $query = "SELECT date , code FROM requests_tbl WHERE status ='0'";
 }
 else
 {
  $query = "SELECT date , code FROM requests_tbl WHERE status ='0' AND Department = '$department'";
 }
...
<div class="amazing-container">
  ...
  while ($row = mysqli_fetch_array($result)) 
  {
    ...
    <tr>
      ...
      <td class='details-cell'><input type='submit' name='details$i' value='DETAILS'></td>
